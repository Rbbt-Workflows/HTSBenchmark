...
require 'tasks/HTSBenchmark/references'
require 'tasks/HTSBenchmark/genotypes'
require 'tasks/HTSBenchmark/gen_reads'
require 'tasks/HTSBenchmark/sample'
require 'tasks/HTSBenchmark/SV'
require 'tasks/HTSBenchmark/clone'
require 'tasks/HTSBenchmark/population'
require 'tasks/HTSBenchmark/expression'
require 'tasks/HTSBenchmark/simulate_population'
require 'tasks/HTSBenchmark/slice'
