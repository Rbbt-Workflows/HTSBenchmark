module HTSBenchmark
  ...
  dep :genotype_germline_hg38, :compute => :produce, :jobname => 'Default'
  dep :genotype_somatic_hg38, :compute => :produce, :jobname => 'Default'
  ...
  dep_task :simulate_tumor, HTSBenchmark, :NEAT_simulate_DNA, :reference => :miniref_ploidy, :mutations => :merge_somatic_germline, :haploid_reference => true, :depth => 60 do |jobname,options|
    options = Misc.add_defaults options, :jobname => jobname + "_tumor"
  ...
  dep_task :simulate_normal, HTSBenchmark, :NEAT_simulate_DNA, :reference => :miniref_ploidy, :mutations => :genotype_germline_hg38, :haploid_reference => true do |jobname,options|
    options = Misc.add_defaults options, :jobname => jobname + "_normal"
